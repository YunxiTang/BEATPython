...
class FlaxTrainer:
    ...
    def _init_train_state(self, *inp_sample):
        ...
        variables = self.model.init(
            {"params": params_key, "dropout": dropout_key}, *inp_sample
        )
        ...
        optimizer = optax.chain(optax.clip_by_global_norm(1.0), optimizer_)
    ...
    def create_function(self):
        ...
        # train step function
        def train_step(state: TrainState, noises, noisy_sample, timesteps, label_conds):
        ...
        # eval step function
        def eval_step(state: TrainState, noises, noisy_sample, timesteps, label_conds):
            loss_val, updated_model_state = loss_fn(
                state.params,
                state,
                noises,
                noisy_sample,
    ...
    def train(self, train_ds, eval_ds=None, test_ds=None):
        ...
        for epoch in range(50):
            ...
            for batch in train_dataset.iter(32):
                ...
                metric, self.train_state = jitted_train_step(
                    self.train_state, noises, noisy_sample, timesteps, label_conds
                )
