...
in_shardings = (NamedSharding(mesh, PartitionSpec('batch',)))
...
shard_fp = shard_map(generate_random_fp1, mesh, 
...
jitted_fp = jax.jit(
    generate_random_fp2, in_shardings=None, out_shardings=out_shardings
)
print(res1.shape)
jitted_fp()
