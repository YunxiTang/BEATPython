...
class FlaxTrainer:
    ...
    def _init_train_state(self, *inp_sample):
        ...
        variables = self.model.init({'params': params_key,
                                     'latent_sample': dropout_key}, *inp_sample)
    ...
    def train(self):
        ...
        ds = load_dataset("ylecun/mnist",
                          cache_dir='/home/yxtang/CodeBase/PythonCourse/dataset')
        ...
        for epoch in range(100):
            ...
            if epoch % 5 == 0:
                variables = {'params': self.train_state.params,
                             'batch_stats': self.train_state.batch_stats}
                
                res1 = model.apply(variables,
                                  latents1, labels,
                                  method=VAE.generate)
                res2 = model.apply(variables,
                                  latents2, labels,
                                  method=VAE.generate)
