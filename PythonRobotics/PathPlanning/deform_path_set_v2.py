...
with open("/home/yxtang/CodeBase/PythonCourse/PythonRobotics/PathPlanning/result/v2/with_kp_s6.pkl", "rb") as fp:
...
pivot_path[6].set_state(jnp.array([pivot_path[6].state[0], 
                                   pivot_path[6].state[1]+2.0,
                                   pivot_path[6].state[2]]))

pivot_path[8].set_state(jnp.array([pivot_path[8].state[0], 
                                   pivot_path[8].state[1]+6.0,
                                   pivot_path[8].state[2]+8.0]))

pivot_path[9].set_state(jnp.array([pivot_path[9].state[0]-2, 
                                   pivot_path[9].state[1]+12.0,
                                   pivot_path[9].state[2]+2.0]))

pivot_path[10].set_state(jnp.array([pivot_path[10].state[0], 
                                    pivot_path[10].state[1]+8.0,
                                    pivot_path[10].state[2]+2.0]))

pivot_path[11].set_state(jnp.array([pivot_path[11].state[0], 
                                    pivot_path[11].state[1]+3.0,
                                    pivot_path[11].state[2]+0.0]))

pivot_path[12].set_state(jnp.array([pivot_path[12].state[0], 
                                    pivot_path[12].state[1]+4.0,
                                    pivot_path[12].state[2]+0.0]))
#=============== transfer path ==================#
# start = np.array([0., 100., 30.])
# goal = jnp.array([150., 70., 120.])

transferred_start = jnp.array([[0., 5., 30.],
                               [0., 15., 30.],
                               [0., 25., 30.],
                               [0., 35., 30.],
                               [0., 45., 30.],
...
transferred_goal = jnp.array([[195., 70., 120.],
                              [190., 70., 125.],
                              [185., 70., 130.],
                              [180., 70., 135.],
                              [175., 70., 140.],
