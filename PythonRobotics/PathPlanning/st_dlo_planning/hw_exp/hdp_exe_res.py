if __name__ == '__main__':
    ...
    # planned shape
    planned_dlo_shape = np.load('/home/yxtang/CodeBase/PythonCourse/PythonRobotics/PathPlanning/st_dlo_planning/results/realworld_result/optimal_shape_seq_res/so_task1_optimal_shape_seq.npy')
