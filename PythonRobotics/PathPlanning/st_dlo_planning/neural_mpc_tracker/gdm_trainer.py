    ...
    def run(self):
        ...
        for sub_data_dir in train_data_dirs:
            ...
            for train_data_path in train_data_paths:
                sub_dataset = MultiStepGDMDataset(
                    data_path=train_data_path, max_step=self._cfg.train_dataloader.step
                )
        ...
        for sub_data_dir in test_data_dirs:
            ...
            for test_data_path in test_data_paths:
                sub_dataset = MultiStepGDMDataset(
                    data_path=test_data_path, max_step=self._cfg.train_dataloader.step
                )
            ...
            if epoch_idx % cfg.train.validation_every == 0:
                with torch.no_grad():
                    ...
                    for ele in val_dataloader:
                        ...
                        total_samples += ele["dlo_keypoints"].shape[0]
                print(
                    f"Epoch {self.epoch}: Train Loss {train_loss} || Val Loss {val_loss}"
                )
