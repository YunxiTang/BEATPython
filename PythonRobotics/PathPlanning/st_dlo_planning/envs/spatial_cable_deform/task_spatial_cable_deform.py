...
class DualGripperCableEnv(MujocoEnv, utils.EzPickle):
    ...
    def __init__(self, task:str, feat_stride:int, **kargs):
        ...
        self.left_hand_jnt_idxs = [self._get_joint_index(joint_name) for joint_name in ['left_px', 'left_py', 'left_pz',
                                                                                        'left_rx', 'left_ry', 'left_rz']]
        self.right_hand_jnt_idxs = [self._get_joint_index(joint_name) for joint_name in ['right_px', 'right_py', 'right_pz',
