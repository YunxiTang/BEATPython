...
if __name__ == "__main__":
    ...
    with open(
        "/home/yxtang/CodeBase/PythonCourse/PythonRobotics/PathPlanning/result/node_list_with_kp_s5.pkl",
        "rb",
    ) as fp:
        planner._node_list = pickle.load(fp)

    with open(
        "/home/yxtang/CodeBase/PythonCourse/PythonRobotics/PathPlanning/result/final_node_s4.pkl",
        "rb",
    ) as fp:
    ...
    if path_sol is not None:
        ...
        planner.save_result(
            path_sol[0],
            "/home/yxtang/CodeBase/PythonCourse/PythonRobotics/PathPlanning/result/with_kp_s6.pkl",
        )
        planner.save_result(
            planner._node_list,
            "/home/yxtang/CodeBase/PythonCourse/PythonRobotics/PathPlanning/result/node_list_with_kp_s6.pkl",
        )
        planner.save_result(
            planner._potential_final_node,
            "/home/yxtang/CodeBase/PythonCourse/PythonRobotics/PathPlanning/result/final_node_s6.pkl",
        )
