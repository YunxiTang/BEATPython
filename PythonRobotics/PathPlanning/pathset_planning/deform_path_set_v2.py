...
# ======================= deformable the path ====================== #
transfered_path_list[1][5].set_state(
    jnp.array(
        [
            transfered_path_list[1][5].state[0],
...
transfered_path_list[1][6].set_state(
    jnp.array(
        [
            transfered_path_list[1][6].state[0],
...
transfered_path_list[1][7].set_state(
    jnp.array(
        [
            transfered_path_list[1][7].state[0],
