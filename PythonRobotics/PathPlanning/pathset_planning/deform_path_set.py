...
with open(
    "/home/yxtang/CodeBase/PythonCourse/PythonRobotics/PathPlanning/result/v1/with_kp_s5.pkl",
    "rb",
) as fp:
...
pivot_path[1].set_state(
    jnp.array(
        [pivot_path[1].state[0], pivot_path[1].state[1] - 4.0, pivot_path[1].state[2]]
    )
)
pivot_path[2].set_state(
    jnp.array(
        [pivot_path[2].state[0], pivot_path[2].state[1] - 5.0, pivot_path[2].state[2]]
    )
)
pivot_path[3].set_state(
    jnp.array(
        [pivot_path[3].state[0], pivot_path[3].state[1] - 3.0, pivot_path[3].state[2]]
    )
)
pivot_path[4].set_state(
    jnp.array(
        [pivot_path[4].state[0], pivot_path[4].state[1] - 4.0, pivot_path[4].state[2]]
    )
)
pivot_path[5].set_state(
    jnp.array(
        [pivot_path[5].state[0] + 0, pivot_path[5].state[1] - 6, pivot_path[5].state[2]]
    )
)
pivot_path[6].set_state(
    jnp.array(
        [
            pivot_path[6].state[0] + 8,
            pivot_path[6].state[1] - 8.0,
            pivot_path[6].state[2],
        ]
    )
)
pivot_path[7].set_state(
    jnp.array(
        [
            pivot_path[7].state[0] + 6,
...
pec_pivot_path = transfer_path(
    pivot_path[0:8],
    start=0,
    goal=0,
    delta_start=jnp.array([0.0, 0.0, 0.0]),
    delta_goal=jnp.array([6.0, -8.0, 0.0]),
)
...
transfered_path_list[0][6].set_state(
    jnp.array(
        [
            transfered_path_list[0][6].state[0] - 0.25,
            transfered_path_list[0][6].state[1] + 5.0,
            transfered_path_list[0][6].state[2],
        ]
    )
)
transfered_path_list[0][7].set_state(
    jnp.array(
        [
            transfered_path_list[0][7].state[0] - 2.0,
            transfered_path_list[0][7].state[1] + 8.0,
            transfered_path_list[0][7].state[2],
        ]
    )
)
transfered_path_list[0][8].set_state(
    jnp.array(
        [
            transfered_path_list[0][8].state[0] + 10.0,
            transfered_path_list[0][8].state[1] + 1.0,
            transfered_path_list[0][8].state[2],
        ]
    )
)
transfered_path_list[0][9].set_state(
    jnp.array(
        [
            transfered_path_list[0][9].state[0] + 7.0,
            transfered_path_list[0][9].state[1] + 4.0,
            transfered_path_list[0][9].state[2],
        ]
    )
)
transfered_path_list[0][10].set_state(
    jnp.array(
        [
            transfered_path_list[0][10].state[0] + 12.0,
            transfered_path_list[0][10].state[1] + 6.0,
            transfered_path_list[0][10].state[2],
        ]
    )
)
transfered_path_list[0][11].set_state(
    jnp.array(
        [
            transfered_path_list[0][11].state[0] + 7.0,
            transfered_path_list[0][11].state[1] + 1.0,
            transfered_path_list[0][11].state[2],
        ]
    )
)
transfered_path_list[0][12].set_state(
    jnp.array(
        [
            transfered_path_list[0][12].state[0] + 5.0,
            transfered_path_list[0][12].state[1] + 0.0,
            transfered_path_list[0][12].state[2],
        ]
    )
)

transfered_path_list[1][6].set_state(
    jnp.array(
        [
            transfered_path_list[1][6].state[0] + 0,
            transfered_path_list[1][6].state[1] + 3.0,
            transfered_path_list[1][6].state[2],
        ]
    )
)
transfered_path_list[1][7].set_state(
    jnp.array(
        [
            transfered_path_list[1][7].state[0] + 0,
            transfered_path_list[1][7].state[1] + 5.0,
            transfered_path_list[1][7].state[2],
        ]
    )
)
transfered_path_list[1][8].set_state(
    jnp.array(
        [
            transfered_path_list[1][8].state[0] + 15,
            transfered_path_list[1][8].state[1] - 6.0,
            transfered_path_list[1][8].state[2],
        ]
    )
)
transfered_path_list[1][9].set_state(
    jnp.array(
        [
            transfered_path_list[1][9].state[0] + 7,
            transfered_path_list[1][9].state[1] + 2.0,
            transfered_path_list[1][9].state[2],
        ]
    )
)
transfered_path_list[1][10].set_state(
    jnp.array(
        [
            transfered_path_list[1][10].state[0] + 4,
            transfered_path_list[1][10].state[1] + 6.0,
            transfered_path_list[1][10].state[2],
        ]
    )
)
transfered_path_list[1][11].set_state(
    jnp.array(
        [
            transfered_path_list[1][11].state[0] + 0,
            transfered_path_list[1][11].state[1] + 10.0,
            transfered_path_list[1][11].state[2],
        ]
    )
)
transfered_path_list[1][12].set_state(
    jnp.array(
        [
            transfered_path_list[1][12].state[0] + 0,
...
transfered_path_list[2][6].set_state(
    jnp.array(
        [
            transfered_path_list[2][6].state[0] + 0,
            transfered_path_list[2][6].state[1] + 4.0,
            transfered_path_list[2][6].state[2],
        ]
    )
)
transfered_path_list[2][7].set_state(
    jnp.array(
        [
            transfered_path_list[2][7].state[0] - 1,
            transfered_path_list[2][7].state[1] + 7.0,
            transfered_path_list[2][7].state[2],
        ]
    )
)
transfered_path_list[2][8].set_state(
    jnp.array(
        [
            transfered_path_list[2][8].state[0] + 10,
            transfered_path_list[2][8].state[1] - 5.0,
            transfered_path_list[2][8].state[2],
        ]
    )
)
transfered_path_list[2][10].set_state(
    jnp.array(
        [
            transfered_path_list[2][10].state[0] - 2,
            transfered_path_list[2][10].state[1] + 6.0,
            transfered_path_list[2][10].state[2],
        ]
    )
)
transfered_path_list[2][11].set_state(
    jnp.array(
        [
            transfered_path_list[2][11].state[0] - 2,
            transfered_path_list[2][11].state[1] + 11.5,
            transfered_path_list[2][11].state[2],
        ]
    )
)
transfered_path_list[2][12].set_state(
    jnp.array(
        [
            transfered_path_list[2][12].state[0] + 2,
...
transfered_path_list[3][3].set_state(
    jnp.array(
        [
            transfered_path_list[3][3].state[0] - 0,
            transfered_path_list[3][3].state[1] - 1.0,
            transfered_path_list[3][3].state[2],
        ]
    )
)
transfered_path_list[3][4].set_state(
    jnp.array(
        [
            transfered_path_list[3][4].state[0] - 0,
            transfered_path_list[3][4].state[1] - 1.0,
            transfered_path_list[3][4].state[2],
        ]
    )
)
transfered_path_list[3][6].set_state(
    jnp.array(
        [
            transfered_path_list[3][6].state[0] - 3,
            transfered_path_list[3][6].state[1] + 6.0,
            transfered_path_list[3][6].state[2],
        ]
    )
)
transfered_path_list[3][7].set_state(
    jnp.array(
        [
            transfered_path_list[3][7].state[0] - 3,
            transfered_path_list[3][7].state[1] + 14.0,
            transfered_path_list[3][7].state[2],
        ]
    )
)
transfered_path_list[3][8].set_state(
    jnp.array(
        [
            transfered_path_list[3][8].state[0] + 7,
            transfered_path_list[3][8].state[1] + 3.0,
            transfered_path_list[3][8].state[2],
        ]
    )
)
transfered_path_list[3][9].set_state(
    jnp.array(
        [
            transfered_path_list[3][9].state[0] + 1,
            transfered_path_list[3][9].state[1] + 5.5,
            transfered_path_list[3][9].state[2],
        ]
    )
)
transfered_path_list[3][10].set_state(
    jnp.array(
        [
            transfered_path_list[3][10].state[0] + 6,
            transfered_path_list[3][10].state[1] + 10.0,
            transfered_path_list[3][10].state[2],
        ]
    )
)
transfered_path_list[3][11].set_state(
    jnp.array(
        [
            transfered_path_list[3][11].state[0] + 6,
            transfered_path_list[3][11].state[1] + 3.0,
            transfered_path_list[3][11].state[2],
        ]
    )
)
transfered_path_list[3][12].set_state(
    jnp.array(
        [
            transfered_path_list[3][12].state[0] + 5,
            transfered_path_list[3][12].state[1] + 1.5,
            transfered_path_list[3][12].state[2],
        ]
    )
)
transfered_path_list[3][13].set_state(
    jnp.array(
        [
            transfered_path_list[3][13].state[0] + 1,
...
transfered_path_list[4][3].set_state(
    jnp.array(
        [
            transfered_path_list[4][3].state[0] - 0.0,
            transfered_path_list[4][3].state[1] - 1.0,
            transfered_path_list[4][3].state[2],
        ]
    )
)
transfered_path_list[4][4].set_state(
    jnp.array(
        [
            transfered_path_list[4][4].state[0] - 0.0,
            transfered_path_list[4][4].state[1] - 1.0,
            transfered_path_list[4][4].state[2],
        ]
    )
)
transfered_path_list[4][5].set_state(
    jnp.array(
        [
            transfered_path_list[4][5].state[0] + 1.5,
            transfered_path_list[4][5].state[1] - 0.0,
            transfered_path_list[4][5].state[2],
        ]
    )
)
transfered_path_list[4][6].set_state(
    jnp.array(
        [
            transfered_path_list[4][6].state[0] - 5.0,
            transfered_path_list[4][6].state[1] + 8.0,
            transfered_path_list[4][6].state[2],
        ]
    )
)
transfered_path_list[4][7].set_state(
    jnp.array(
        [
            transfered_path_list[4][7].state[0] - 4.0,
            transfered_path_list[4][7].state[1] + 18.0,
            transfered_path_list[4][7].state[2],
        ]
    )
)
transfered_path_list[4][8].set_state(
    jnp.array(
        [
            transfered_path_list[4][8].state[0] + 8.0,
            transfered_path_list[4][8].state[1] + 8.0,
            transfered_path_list[4][8].state[2],
        ]
    )
)
transfered_path_list[4][9].set_state(
    jnp.array(
        [
            transfered_path_list[4][9].state[0] + 8.0,
            transfered_path_list[4][9].state[1] + 10.0,
            transfered_path_list[4][9].state[2],
        ]
    )
)
transfered_path_list[4][10].set_state(
    jnp.array(
        [
            transfered_path_list[4][10].state[0] + 10.5,
            transfered_path_list[4][10].state[1] + 13.0,
            transfered_path_list[4][10].state[2],
        ]
    )
)
transfered_path_list[4][11].set_state(
    jnp.array(
        [
            transfered_path_list[4][11].state[0] + 8.0,
            transfered_path_list[4][11].state[1] + 7.0,
            transfered_path_list[4][11].state[2],
        ]
    )
)
transfered_path_list[4][12].set_state(
    jnp.array(
        [
            transfered_path_list[4][12].state[0] + 8.0,
            transfered_path_list[4][12].state[1] + 6.0,
            transfered_path_list[4][12].state[2],
        ]
    )
)
transfered_path_list[4][13].set_state(
    jnp.array(
        [
            transfered_path_list[4][13].state[0] + 4.0,
            transfered_path_list[4][13].state[1] + 0.0,
