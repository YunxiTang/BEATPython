...
class JoyStickInterface:
    ...
    def __init__(self):
        ...
        self.trans_publisher = rospy.Publisher('/Tele/DeltaTranslation', transform, queue_size=1)
        self.orien_publisher = rospy.Publisher('/Tele/DeltaWristJoint', Float32, queue_size=1)
    ...
    def JoyCallback(self, msg: Joy):
        ...
        t_cmd.transform.rotation.x = 0.
        t_cmd.transform.rotation.y = 0.
        t_cmd.transform.rotation.z = 0.
        t_cmd.transform.rotation.w = 1.
