...
if __name__ == "__main__":
    ...
    cap = cv2.VideoCapture(
        "/media/yxtang/Extreme SSD/DOM_Reaseach/dobert_cache/dobert_dataset/dom_dataset/episode_4009/episode_4009.mp4"
    )
    ...
    while True:
        ...
        for i in range(len(data_res["nodes"]) - 1):
            ...
            image = cv2.circle(
                canvas, (pos[1], pos[0]), radius=2, color=(0, 0, 255), thickness=-1
            )
